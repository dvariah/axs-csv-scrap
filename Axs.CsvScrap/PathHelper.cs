namespace Axs.CsvScrap
{
    public class PathHelper
    {
        ...
        {
            return $"{workFolderPath}\\input\\sales\\{countryCode}\\{cityName}\\axs_sales_{countryCode}_{cityName}_{code}_control_card.csv.gz";
        }
        ...
        {
            return $"{workFolderPath}\\input\\payment\\{countryCode}\\{cityName}\\axs_payment_{countryCode}_{cityName}_{code}_control_card.csv.gz";
        }
        ...
        {
            return $"{workFolderPath}\\input\\payment_distribution\\{countryCode}\\{cityName}\\axs_payment_distribution_{countryCode}_{cityName}_{code}_control_card.csv.gz";
        }
    }
}
